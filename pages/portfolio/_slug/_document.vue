<template>
  ...
  >
    ...
    >
      <div class="doccont-imgcontent" ref="doccontImgContent">
        <img
          class="doccont-img"
          ref="doccontImg"
          :src="`http://localhost:1337${document.images[0].url}`"
        />
	...
	<div class="doccont-scroller" ref="doccontScroller">
	 <div v-if="document.images && document.images[0]" class="doccont-imgcontainer"
      :style="`padding-top:calc(${(document.images[0].formats.large.height / document.images[0].formats.large.width) *100}% - 64px);`"></div>
    	<div class="doccont-content">
      <div class="doccont-content-col1" ref="doccontContentCol1">
        <div
          v-if="document.poster"
        ...
        >
          <img
            ...
            :src="`http://localhost:1337${document.poster.formats.medium.url}`"
          />
        </div>
        <div class="moreinfo-container" v-if="document.moreinfo">
          ...
          >
            ...
            <a v-if="info.link && info.outlink" :href="info.link"
              ><div
                class="icon"
  ...
  mounted: function () {
    ...
    gsap.to(this.$refs.doccontContentCol1, {
      scrollTrigger: {
		...
		triggerEnd:this.$refs.container,
		start: "top-=64",
		end:"100%",
		markers: true,
		pin: true,
